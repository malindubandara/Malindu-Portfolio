      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <a href="/Malindu_Bandara_CV.pdf" download>
                <motion.button
          ...
          >
            ...
            <div className="relative">
              ...
              >
                <img
                  src="/src/assets/profile.png?height=400&width=300"
                  alt="Profile"
                  className="w-56 h-72 sm:w-64 sm:h-80 lg:w-80 lg:h-96 object-cover rounded-lg"
                />
              </motion.div>
            </div>
